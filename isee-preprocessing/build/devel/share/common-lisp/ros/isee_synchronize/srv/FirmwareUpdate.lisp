...
(cl:in-package isee_synchronize-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <FirmwareUpdate-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FirmwareUpdate-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name isee_synchronize-srv:<FirmwareUpdate-request> is deprecated: use isee_synchronize-srv:FirmwareUpdate-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <FirmwareUpdate-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader isee_synchronize-srv:filename-val is deprecated.  Use isee_synchronize-srv:filename instead.")
  (filename m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FirmwareUpdate-request>)))
  ...
  "isee_synchronize/FirmwareUpdateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FirmwareUpdate-request)))
  "Returns string type for a service object of type 'FirmwareUpdate-request"
  "isee_synchronize/FirmwareUpdateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FirmwareUpdate-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FirmwareUpdate-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name isee_synchronize-srv:<FirmwareUpdate-response> is deprecated: use isee_synchronize-srv:FirmwareUpdate-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <FirmwareUpdate-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader isee_synchronize-srv:success-val is deprecated.  Use isee_synchronize-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'message-val :lambda-list '(m))
(cl:defmethod message-val ((m <FirmwareUpdate-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader isee_synchronize-srv:message-val is deprecated.  Use isee_synchronize-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FirmwareUpdate-response>)))
  ...
  "isee_synchronize/FirmwareUpdateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FirmwareUpdate-response)))
  "Returns string type for a service object of type 'FirmwareUpdate-response"
  "isee_synchronize/FirmwareUpdateResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FirmwareUpdate)))
  ...
  "isee_synchronize/FirmwareUpdate")