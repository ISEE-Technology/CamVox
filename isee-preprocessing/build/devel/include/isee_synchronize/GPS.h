// Generated by gencpp from file isee_synchronize/GPS.msg
// DO NOT EDIT!


#ifndef ISEE_SYNCHRONIZE_MESSAGE_GPS_H
#define ISEE_SYNCHRONIZE_MESSAGE_GPS_H
...
struct GPS_
{
  ...
  typedef boost::shared_ptr< ::isee_synchronize::GPS_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::isee_synchronize::GPS_<ContainerAllocator> const> ConstPtr;

}; // struct GPS_

typedef ::isee_synchronize::GPS_<std::allocator<void> > GPS;

typedef boost::shared_ptr< ::isee_synchronize::GPS > GPSPtr;
typedef boost::shared_ptr< ::isee_synchronize::GPS const> GPSConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::isee_synchronize::GPS_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::isee_synchronize::GPS_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::isee_synchronize::GPS_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::isee_synchronize::GPS_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::isee_synchronize::GPS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::isee_synchronize::GPS_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::isee_synchronize::GPS_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::isee_synchronize::GPS_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::isee_synchronize::GPS_<ContainerAllocator> >
{
  ...
  static const char* value(const ::isee_synchronize::GPS_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6aa847d654b817ffULL;
  static const uint64_t static_value2 = 0x4bb5ba8c773b2a17ULL;
};

template<class ContainerAllocator>
struct DataType< ::isee_synchronize::GPS_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::isee_synchronize::GPS_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::isee_synchronize::GPS_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::isee_synchronize::GPS_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::isee_synchronize::GPS_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // ISEE_SYNCHRONIZE_MESSAGE_GPS_H
